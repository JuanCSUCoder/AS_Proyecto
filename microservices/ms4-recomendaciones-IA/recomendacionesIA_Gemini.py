...
def realizar_peticion():
    ...
    productos_disponibles = data.get('productos_disponibles', '')
    ...
    if productos_comprados and productos_disponibles:
        ...
        return jsonify({'error': 'Se requieren productos_comprados y productos_disponibles en el cuerpo del JSON'})
